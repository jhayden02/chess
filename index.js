...
Module['FS_createPath']("/", "res", true, true);
    ...
    loadPackage({"files": [{"filename": "/res/board.png", "start": 0, "end": 5375}, {"filename": "/res/pieces.png", "start": 5375, "end": 7986}], "remote_package_size": 7986});

  })();

// end include: /tmp/tmprija0_qz.js
// include: /tmp/tmp8o4mpzhl.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp8o4mpzhl.js
// include: /tmp/tmp1f27jupu.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach(function(task) {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp1f27jupu.js
...
var ASM_CONSTS = {
  93749: () => { if (document.fullscreenElement) return 1; },  
 93795: () => { return Module.canvas.width; },  
 93827: () => { return parseInt(Module.canvas.style.width); },  
 93875: () => { document.exitFullscreen(); },  
 93902: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 93974: () => { if (document.fullscreenElement) return 1; },  
 94020: () => { return Module.canvas.width; },  
 94052: () => { return screen.width; },  
 94077: () => { document.exitFullscreen(); },  
 94104: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 94237: () => { return window.innerWidth; },  
 94263: () => { return window.innerHeight; },  
 94290: () => { if (document.fullscreenElement) return 1; },  
 94336: () => { return Module.canvas.width; },  
 94368: () => { return parseInt(Module.canvas.style.width); },  
 94416: () => { if (document.fullscreenElement) return 1; },  
 94462: () => { return Module.canvas.width; },  
 94494: () => { return screen.width; },  
 94519: () => { return window.innerWidth; },  
 94545: () => { return window.innerHeight; },  
 94572: () => { if (document.fullscreenElement) return 1; },  
 94618: () => { return Module.canvas.width; },  
 94650: () => { return screen.width; },  
 94675: () => { document.exitFullscreen(); },  
 94702: () => { if (document.fullscreenElement) return 1; },  
 94748: () => { return Module.canvas.width; },  
 94780: () => { return parseInt(Module.canvas.style.width); },  
 94828: () => { document.exitFullscreen(); },  
 94855: ($0) => { Module.canvas.style.opacity = $0; },  
 94893: () => { return screen.width; },  
 94918: () => { return screen.height; },  
 94944: () => { return window.screenX; },  
 94971: () => { return window.screenY; },  
 94998: () => { return window.devicePixelRatio; },  
 95034: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 95087: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 95138: () => { Module.canvas.style.cursor = 'none'; },  
 95175: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 95431: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 95482: () => { if (document.pointerLockElement) return 1; },  
 95529: () => { if (document.fullscreenElement) return 1; },  
 95575: () => { return window.innerWidth; },  
 95601: () => { return window.innerHeight; }
};
